  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mx-[2vw] mt-[1vh] pb-[1vh] bg-transparent">
        <Link href="/">
          <Image src={consult_ease_logo} className="cursor-pointer" alt="ConsultEase Logo" width={70} height={35} />
        </Link>
          ...
          <NavigationMenuList>
              ...
              <NavigationMenuContent>
                <ul className="grid gap-3 p-4 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
                  <li className="row-span-3">
                    <NavigationMenuLink asChild>
                      <Link className="flex h-full w-full flex-col justify-end rounded-md bg-gradient-to-b from-muted/50 to-muted p-6 no-underline outline-none focus:shadow-md" href="/">
                        <div className="mb-2 mt-4 text-lg font-medium">Dr. Adrian Bennett, MD</div>
                        <p className="text-sm leading-tight text-muted-foreground">
                          Senior Consultant and Chief Medical Officer (CMO), Internal Medicine and Healthcare Administration, 25+ years in patient care and hospital management
                        </p>
                      </Link>
                    </NavigationMenuLink>
                  </li>
                  <ListItem href="/" title="Dr. Sophia Carter, MBBS, MD">Consultant Pediatrician, Child Health and Development, 12 years</ListItem>
                  <ListItem href="/" title="Dr. Ethan Wilson, MBBS, DM">Cardiologist, Heart and Cardiovascular Diseases, 18 years</ListItem>
                  <ListItem href="/" title="Dr. Priya Sharma, MBBS, MD">General Practitioner, Family Medicine, 8 years</ListItem>
                </ul>
              </NavigationMenuContent>
            </NavigationMenuItem>
            ...
            <NavigationMenuItem>
              ...
              <NavigationMenuContent>
                <ul className="grid w-[400px] gap-3 p-4 md:w-[500px] md:grid-cols-2 lg:w-[600px]">
                  {creatorcompo.map((c) => (
                    <ListItem key={c.title} title={c.title} href={c.href}>{c.description}</ListItem>
                  ))}
                </ul>
              </NavigationMenuContent>
            </NavigationMenuItem>
            ...
            <NavigationMenuItem>
              ...
              <NavigationMenuContent>
                <ul className="grid w-[400px] gap-3 p-4 md:w-[500px] md:grid-cols-2 lg:w-[600px]">
                  {tokenCompo.map((t) => (
                    <ListItem key={t.title} title={t.title} href={t.href}>{t.description}</ListItem>
                  ))}
                </ul>
              </NavigationMenuContent>
            </NavigationMenuItem>
            ...
            <NavigationMenuItem>
              <NavigationMenuLink asChild>
                <Link href="/appointment" className={navigationMenuTriggerStyle()}>Appointment Booking</Link>
              </NavigationMenuLink>
            </NavigationMenuItem>
          </NavigationMenuList>
        </NavigationMenu>
          ...
          <div className="mr-[5vw]">
            <DropdownMenu>
              ...
              <DropdownMenuContent>
                ...
                <Link href="/sub"><DropdownMenuItem>Subscription</DropdownMenuItem></Link>
